...
from .dataset import CUB, CarsDataset, NABirds, dogs, INat2017, FineGrainDataset, FineGrainDataset_final
...
def get_loader(args):
    # args中去選你要的dataset and dataloader => 這裡應該就是DLCV_1
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        #here!! 在這裡選擇dataset 並在後續以此生出dataloader
        train_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    transforms.RandomCrop((448, 448)),
                                    transforms.RandomHorizontalFlip(),
                                    transforms.ToTensor(),
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        # here is the dataset
        trainset = FineGrainDataset(root_dir=args.train_img_path,annotation_file = args.train_csv_name,
                                    transform=train_transform)
        testset = FineGrainDataset(root_dir=args.test_img_path,annotation_file = args.test_csv_name,
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        # here is the dataset
        trainset = FineGrainDataset_final(root_dir=args.train_img_path,annotation_file = args.train_csv_name,
                                    transform=train_transform)
        testset = FineGrainDataset_final(root_dir=args.test_img_path,annotation_file = args.test_csv_name,
                                   transform = test_transform)
