...
class FineGrainDataset_final(Dataset):
    ...
    def __getitem__(self, index):
        img_id = self.annotations.iloc[index, 1]  # 取出image id => ex: DOL/img_07898.jpg
        if self.test == False:
            img = Image.open(os.path.join(self.root_dir, img_id)).convert(
                "RGB")  # 取出image id 對應的圖片本人, 並且轉RGB(等等用transform來轉tensor)
...
def main():
    ...
    parser.add_argument("--pretrained_model_path", default="/home/skchen/ML_practice/final/VRDL_1_TrangFG/output/TransFG_1_checkpoint.bin",
    ...
    test_img_path = "/home/skchen/ML_practice/final/fish"
    test_csv_name = "/home/skchen/ML_practice/final/val.csv"
    test_dataset = FineGrainDataset_final(test_img_path, test_csv_name, test_transform, test=True)
    ...
    result = "/home/skchen/ML_practice/final/submission.csv"
